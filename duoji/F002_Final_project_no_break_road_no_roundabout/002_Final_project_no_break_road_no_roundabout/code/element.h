...
#define many_count              11              //最多找多少行/列（带坐标点）
#define many_count1             11               //最多找多少行/列（单纯数跳变点）
#define point_count             18              //每行最多跳变点个数
...
#define PEAK_CENTER             (0.3f)                  //画面权重值（范围0.2f到1.0f）
#define PEAK_CENTER_ROUNDABOUT  (0.3f)                  //环岛处权重值                        
