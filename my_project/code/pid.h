...
extern Positional_PD_t pid_turn_outer;
extern Positional_PD_t pid_gyro_middle;
extern Incremental_PI_t pid_speed_L;
extern Incremental_PI_t pid_speed_R;
extern uint8_t blind_turn_finished;
