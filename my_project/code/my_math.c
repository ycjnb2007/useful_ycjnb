...
const float Gyro_G = 0.03051756 * 2 * 1.674; // 陀螺仪初始化量程+-2000度每秒于1 / (65536 / 4000) = 0.03051756*2
...
====================================================================================================
//逼近法；线性拟合
//Q (4/MY_PI x - 4/MY_PI^2 x^2) + P (4/MY_PI x - 4/MY_PI^2 x^2)^2
#ifndef TAPYOR
float sine(float x)          // (-MY_PI , MY_PI) ???? 0.0005
{
    const float Q = 0.775;
    const float P = 0.225;
...
//cos(x)=sin(MY_PI/2+x)=sin(MY_PI/2-x)
//cos(x-MY_PI/2)=sin(x)
float cosine(float x)
{
    return sine(x+MY_PI/2);//奇变偶不变，符号看象限
}
